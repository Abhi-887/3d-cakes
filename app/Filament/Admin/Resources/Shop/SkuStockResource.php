        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\TernaryFilter::make('has_base_on_stocks_warning')
                    ->translateLabel()
                    ->queries(
                        true: fn (SkuStockEloquentQueryBuilder $query) => $query->whereBaseOnStocksIsWarning(),
                        false: fn (SkuStockEloquentQueryBuilder $query) => $query->whereBaseOnStocksIsNotWarning(),
                    ),
            ])
            ->actions([
