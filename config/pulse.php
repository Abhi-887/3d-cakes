    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            ...
            'ignore' => [
                ...
                '/^health:checks:queue:latestHeartbeatAt./', // spatie/laravel-health - QueueCheck
                '/^laravel-health:check-/', // spatie/laravel-health - CacheCheck
                '/^health:checks:schedule:latestHeartbeatAt/', // spatie/laravel-health - ScheduleCheck
            ],
            'groups' => [
        ...
        Recorders\SlowRequests::class => [
            ...
            'ignore' => [
                '#^/admin/pulse$#', // Pulse dashboard...
                '#^/admin/telescope#', // Telescope dashboard...
                '#^/up#',
            ],
        ],
