 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Spatie\Activitylog\Models\Activity[] $causerActivities
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Domain\Access\Admin\Models\Admin whereTheme($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Domain\Access\Admin\Models\Admin whereThemeColor($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Domain\Access\Admin\Models\Admin whereUuid($value)
...
class Admin extends Authenticatable implements FilamentUser, HasAvatar, HasTenants, MustVerifyEmail
{
    ...
    public function isZeroDayAdmin(): bool
    {
        ...
        return 'lloricode@gmail.com' === $this->email;
    }
